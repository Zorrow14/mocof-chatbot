export function getWarrantyKnowledge() {
    return `
MOCOF WARRANTY & POLICIES:
...
DP TECH MATTRESS (10-inch Double Posture Coil — included with Murano Series)
- Coverage: 10 to 12 years (model dependent)
- Covers: Manufacturing defects only
- Non-returnable once opened (hygiene regulations), except manufacturing defects

SUNBRELLA PERFORMANCE FABRIC
- Coverage: 5 years color discoloration and fade warranty
- Covers: Fading and fabric failure under normal use

MOCOF BASIC WARDROBES
- Standard: 1-year structural cabinetry warranty
- Extended: Additional 2 years for registered members (total 3 years)
- Subject to repair and component replacement rather than full refund

LAMPS & ACCESSORIES
- 7-day return window in original packaging with proof of purchase for full refund
...
AFTER-SALES SUPPORT:
- Installation by MOCOF trained technicians
- Post-installation adjustments available
